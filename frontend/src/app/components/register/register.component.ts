        ...
        <mat-card-content>
          <form (ngSubmit)="register()">
            ...
            <mat-form-field appearance="fill" class="full-width">
              ...
              <input matInput [(ngModel)]="contactInfo" name="contactInfo" required>
            </mat-form-field>
...
export class RegisterComponent implements OnInit {
  ...
  register() {
    this.auth.register({ name: this.name, email: this.email, password: this.password, role: this.role, contact_info: this.contactInfo }).subscribe({
      next: () => {
